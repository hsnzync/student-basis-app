<template>
    <div class="filter-section py-4">
        <ul class="p-0 m-0 row">
            <li class="filter-icon col-1 p-0"><i class="fas fa-sliders-h"></i></li>
            <li :class="{ 'is-active': activeStatus == '' }" @click="handleFilter('')">
            ...
            <li :class="{ 'is-active': activeStatus == 'Bezig' }" @click="handleFilter('Bezig')">
...
export default {
    ...
    methods: {
        handleFilter(status) {
            ...
            this.$emit('filterItems', this.activeStatus)
        }
    }
}
</script>
